...
-- JDBC authorization
insert into users (username, password, enabled) values ('new_user', 'password', 1);
insert into authorities (username, authority) VALUES ('new_user', 'ROLE_ADMIN');

insert into AUTO_USER (autoUserId, EMAIL, FIRST_NAME, LAST_NAME, PASSWORD, USERNAME, ROLE) values (null, 'kevin.m.bowersox@gmail.com', 'Kevin', 'Bowersox', 'password', 'kevin', 'ROLE_ADMIN');
